...
namespace SpaceBounceBall
{
    public static class Layers
    {
        ...
        public const int Number_Character       = 8;
        public const int Number_Map             = 9;
        public const int Number_TouchArea       = 10;

        /* 2. 레이어 마스크(shifted) */
        public const int IgnoreRaycast  = 1 << 2;
        public const int Character      = 1 << 8;
        public const int Map            = 1 << 9;
        public const int TouchArea      = 1 << 10;
